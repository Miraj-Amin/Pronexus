    ...
    <div className={'crm' + (navOpen ? ' nav-open' : '')}>
      ...
      <aside className="crm-side">
        ...
        <nav className="crm-nav">
          ...
          <button className={topView === 'admin' ? 'on' : ''} onClick={() => setTopView('admin')}><span className="ic"><svg width="17" height="17" viewBox="0 0 18 18" fill="none"><path d="M9 2.5l1.2 2.4 2.6.4-1.9 1.9.4 2.6L9 8.6 6.7 9.8l.4-2.6-1.9-1.9 2.6-.4L9 2.5z" stroke="currentColor" strokeWidth="1.3" strokeLinejoin="round"/><path d="M5 14.5a4 4 0 018 0" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round"/></svg></span>Funder Parameters</button>
          <button className={topView === 'mi' ? 'on' : ''} onClick={() => setTopView('mi')}><span className="ic"><svg width="17" height="17" viewBox="0 0 18 18" fill="none"><path d="M3 14.5V9M8 14.5V4.5M13 14.5v-7" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round"/></svg></span>MI &amp; Reporting</button>
